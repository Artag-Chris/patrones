...
class LocationFactory {
  ...
  getLocationIcon(type: string): LocationIcon {
    if (!this.icons[type]) {
      console.log(`%cCreando una nueva instancia para ${type}`,COLORS.red)
...
const locations=[
  new MapLocation(10,20,factory.getLocationIcon('Casa')),
  new MapLocation(30,40,factory.getLocationIcon('Casa')),
  new MapLocation(50,60,factory.getLocationIcon('Oficina')),]
